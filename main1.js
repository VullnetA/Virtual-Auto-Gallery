...
function addLighting(scene) {
  ...
  // Additional lights as defined in the original code...
}

function addStaticElements(scene, textureLoader) {
  ...
  // Floor setup
  // Repeat for each floor with specific textures, geometries, and positions as in the original code...

  // Add more static elements like parking, building floors, walls, etc., here
}

function loadModels(scene, loadingManager) {
...
function main() {
  ...
  addStaticElements(scene, textureLoader);
  addLighting(scene);
